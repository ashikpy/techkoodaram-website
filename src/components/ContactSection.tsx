  ...
  return (
    <section className="py-24 bg-cream relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {/* Email Card - Large Block */}
          <motion.div
            variants={itemVariants}
            className="md:col-span-2 bg-white rounded-3xl p-8 shadow-sm border border-border/50 relative overflow-hidden group hover:shadow-md transition-all duration-300"
          >
          ...
          <motion.div
            variants={itemVariants}
            className="md:col-span-1 bg-white rounded-3xl p-8 shadow-sm border border-border/50 relative overflow-hidden group hover:shadow-md transition-all duration-300"
          >
          ...
          {/* Opportunity 1: Give a Talk */}
          <motion.div
            variants={itemVariants}
            className="bg-white rounded-3xl p-6 shadow-sm border border-border/50 hover:shadow-md transition-all duration-300 group cursor-pointer"
          >
